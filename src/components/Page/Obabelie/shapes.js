...
context2.fillStyle = 'rgba(0,0,0,.75)';
context2.beginPath();
...
context3.fillStyle = 'rgba(0,0,0,.75)';
context3.beginPath();
...
context4.fillStyle = 'rgba(255,255,255,.5)';
context4.beginPath();
...
export default {
  'white-circle': [shape1, 'rgba(0,0,0,0.25)'],
  'black-trinagle': [shape2, 'rgba(255,255,255,0.25)'],
  'black-circle': [shape3, 'rgba(255,255,255,0.25)'],
  'white-trinagle': [shape4, 'rgba(0,0,0,0.25)'],
};
